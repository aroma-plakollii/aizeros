                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                            ...
                            <div className="flex items-center gap-4">
                                <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-white/50 shrink-0">
                        ...
                        <div className="mt-8 bg-white rounded-[24px] py-[32px] px-[28px] w-[327px] h-[370px] flex flex-col shrink-0">
                            ...
                            <div className="grid grid-cols-3 gap-x-4 gap-y-10 items-center justify-items-center mb-10 w-full">
                                <img src="/images/theo-black 1.png" alt="theo" className="w-[60px] object-contain opacity-60 mix-blend-multiply" />
                                <img src="/images/file 1.png" alt="Crona" className="w-[60px] object-contain opacity-60 mix-blend-multiply" />
                                <img src="/images/file(1) 1.png" alt="Mercury" className="w-[60px] object-contain opacity-60 mix-blend-multiply" />
                                <img src="/images/Frame 2147225825.png" alt="hues" className="w-[60px] object-contain opacity-60 mix-blend-multiply" />
                                <img src="/images/Frame 2147225902.png" alt="ZUMAR CONS" className="w-[60px] object-contain opacity-60 mix-blend-multiply" />
                                <img src="/images/9.png" alt="Leafe" className="w-[60px] object-contain opacity-60 mix-blend-multiply" />
                            </div>
                            ...
                            <button
                                ...
                                style={{ background: 'linear-gradient(90deg, #0013FF 0%, #11B7FC 100%)' }}
                            >
                                Book a call
                            </button>
                        </div>
